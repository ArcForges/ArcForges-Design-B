...
| [NOTES.04](#task-notes-04) | Virtualised block layout, measurement caching and scroll anchoring | feature | L | [PLT.26](platform.md#task-plt-26) (artifact) | not-started |
...
| [NOTES.11](#task-notes-11) | Crash recovery and upgrade/downgrade migration | feature | M | [PLT.02](platform.md#task-plt-02) (artifact) | not-started |
...
| Unblocks | [HAR.05](harness.md#task-har-05), [NOTES.06](#task-notes-06), [NOTES.07](#task-notes-07), [NOTES.14](#task-notes-14), [NOTES.19](#task-notes-19), [NOTES.20](#task-notes-20), [NOTES.35](#task-notes-35) |
...
| Start prerequisites | **artifact** [PLT.26](platform.md#task-plt-26) — same design-system/shell package as NOTES.03. *Why:* layout engine renders inside the shared shell's control hosting |
| Entry condition | [ADOPT.04](adoption.md#task-adopt-04) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
...
| Start prerequisites | **artifact** [PLT.02](platform.md#task-plt-02) — the journal/recovery pipeline and StorageSchemaVersion migration apparatus. *Why:* Notes-specific recovery/migration is built directly on the platform-owned journal replay and migration-ordering mechanics (06-data-persistence-and-formats.md S9) |
| Entry condition | [ADOPT.04](adoption.md#task-adopt-04) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
...
| Entry condition | [ADOPT.04](adoption.md#task-adopt-04) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | **integration** [NOTES.35](#task-notes-35) — downstream feed only - this gate does not wait on it, but its evidence later feeds [PG-17](../../../assurance/open-gates-register.md#rule-pg-17) at [WP-25.07](../../work-packages/25-sync-engine-and-blob-lifecycle.md#rule-wp-25.07). *Why:* recorded for traceability, not a blocking edge |
...
| Start prerequisites | **artifact** [NOTES.24](#task-notes-24) — real NOTES.24 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.37](cloud.md#task-cloud-37) — real [WP-25.00](../../work-packages/25-sync-engine-and-blob-lifecycle.md#rule-wp-25.00) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.04](adoption.md#task-adopt-04) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
...
| Start prerequisites | **artifact** [NOTES.01](#task-notes-01) — real NOTES.01 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NOTES.02](#task-notes-02) — real NOTES.02 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NOTES.10](#task-notes-10) — real NOTES.10 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.44](cloud.md#task-cloud-44) — real [WP-25.07](../../work-packages/25-sync-engine-and-blob-lifecycle.md#rule-wp-25.07) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.37](cloud.md#task-cloud-37) — real CLOUD.37 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.38](cloud.md#task-cloud-38) — real CLOUD.38 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.39](cloud.md#task-cloud-39) — real CLOUD.39 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.40](cloud.md#task-cloud-40) — real CLOUD.40 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.41](cloud.md#task-cloud-41) — real CLOUD.41 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.42](cloud.md#task-cloud-42) — real CLOUD.42 available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.04](adoption.md#task-adopt-04) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [CLOUD.47](cloud.md#task-cloud-47), [NOTES.02](#task-notes-02), [NOTES.14](#task-notes-14) |
| Write scope |  |
| Validation | Local real-integration run of the affected scenario in an existing environment, recorded once; offline and static checks in CI; no hosted runtime, device, browser, live-service or inference CI ([P2-017](../../../decisions/phase-2-specification-decisions.md#rule-p2-017)). |
...
| Start prerequisites | **artifact** [PLT.45](platform.md#task-plt-45) — real PLT.45 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.14](native.md#task-nat-14) — real [WP-13.13](../../work-packages/13-high-risk-technical-probes.md#rule-wp-13.13) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NOTES.09](#task-notes-09) — real NOTES.09 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.25](native.md#task-nat-25) — real [WP-13](../../work-packages/13-high-risk-technical-probes.md#rule-wp-13) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.04](adoption.md#task-adopt-04) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
