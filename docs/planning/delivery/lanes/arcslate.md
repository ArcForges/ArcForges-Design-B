...
| Owning repository | ArcSlate (`C:\MyFile\Projects\ArcForges\ArcSlate`); integration owner: ArcSlate integration owner |
| Kind / size | acceptance / S |
| Obligations | [WP-37.90](../../work-packages/37-arcslate-playback-and-processing.md#rule-wp-37.90) — full<br>[WP-37](../../work-packages/37-arcslate-playback-and-processing.md#rule-wp-37) the unlabelled final-review closure paragraph: consume actual Platform media packages, test portable baseline render codecs/graph-source semantics/audio-grid mixing together, confirm unsupported native capabilities cannot be advertised, and that font/colour/source identity affects the render snapshot (the last clause is jointly satisfied here and at SLATE.26) — the unlabelled final-review closure paragraph: consume actual Platform media packages, test portable baseline render codecs/graph-source semantics/audio-grid mixing together, confirm unsupported native capabilities cannot be advertised, and that font/colour/source identity affects the render snapshot (the last clause is jointly satisfied here and at SLATE.26)<br>[WP-37](../../work-packages/37-arcslate-playback-and-processing.md#rule-wp-37) Unlabelled final-review closure: consume actual Platform media packages, portable baseline codec/graph/audio-grid verification, unsupported-capability-cannot-be-advertised, font/colour/source identity affects render snapshot — package-level obligation contribution |
...
| Owning repository | ArcSlate (`C:\MyFile\Projects\ArcForges\ArcSlate`); integration owner: ArcSlate integration owner |
| Kind / size | acceptance / S |
| Obligations | [WP-39.90](../../work-packages/39-arcslate-integration-and-portability.md#rule-wp-39.90) — full<br>[WP-39](../../work-packages/39-arcslate-integration-and-portability.md#rule-wp-39) the unlabelled final-review closure paragraph: Cloud data-model round-trip of complete Slate metadata/archive with originals absent, explicit managed asset uploads, exact grids, graph scopes, titles/subtitles/fonts/colour and ASR source/artifact references; an older DTO cannot truncate the native project before sync — the unlabelled final-review closure paragraph: Cloud data-model round-trip of complete Slate metadata/archive with originals absent, explicit managed asset uploads, exact grids, graph scopes, titles/subtitles/fonts/colour and ASR source/artifact references; an older DTO cannot truncate the native project before sync<br>[WP-39](../../work-packages/39-arcslate-integration-and-portability.md#rule-wp-39) Unlabelled final-review closure: Cloud data-model round-trip of complete Slate metadata/archive, managed asset uploads, exact grids, graph scopes, fonts/colour, ASR references, anti-truncation — package-level obligation contribution |
...
| Start prerequisites | **artifact** [SLATE.37](#task-slate-37) — real SLATE.37 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.39](cloud.md#task-cloud-39) — real [WP-25.02](../../work-packages/25-sync-engine-and-blob-lifecycle.md#rule-wp-25.02) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.44](cloud.md#task-cloud-44) — real [WP-25.07](../../work-packages/25-sync-engine-and-blob-lifecycle.md#rule-wp-25.07) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SLATE.12](#task-slate-12) — real SLATE.12 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SLATE.35](#task-slate-35) — real SLATE.35 available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.06](adoption.md#task-adopt-06) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
