...
| [CLOUD.64](#task-cloud-64) | Full operator contract closure across PublicApi, Commerce, Policy and Console | integration | M | [CLOUD.28](#task-cloud-28) (artifact), [COM.13](commerce.md#task-com-13) (artifact), [POL.05](policy.md#task-pol-05) (artifact), [OPS.05](operations.md#task-ops-05) (artifact) | not-started |
| [CLOUD.66](#task-cloud-66) | Every enumerated sensitive operation wired to the step-up mechanism | integration | M | [CLOUD.15](#task-cloud-15) (artifact), [COM.10](commerce.md#task-com-10) (artifact), [AND.07](android.md#task-and-07) (artifact) | not-started |
| [CLOUD.67](#task-cloud-67) | Combined AI reopen after Cloud disaster-recovery restore | integration | M | [CLOUD.51](#task-cloud-51) (artifact), [HAR.05](harness.md#task-har-05) (artifact) | not-started |
...
| Start prerequisites | **artifact** [CON.07](contracts.md#task-con-07) — real CON.07 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.11](#task-cloud-11) — real [WP-22.00](../../work-packages/22-identity-workspace-and-device.md#rule-wp-22.00) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.66](#task-cloud-66) — package task delivered. *Why:* the package acceptance receipt verifies every task mapped to the package ([DLV-03](../README.md#rule-dlv-03)) |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
...
| Unblocks | [AND.04](android.md#task-and-04), [CLOUD.22](#task-cloud-22), [CLOUD.23](#task-cloud-23), [CLOUD.24](#task-cloud-24), [CLOUD.25](#task-cloud-25), [CLOUD.28](#task-cloud-28), [CLOUD.29](#task-cloud-29), [COM.13](commerce.md#task-com-13), [SIM.05](simulator.md#task-sim-05) |
...
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [CLOUD.26](#task-cloud-26), [CLOUD.28](#task-cloud-28) |
...
| Start prerequisites | **artifact** [CLOUD.03](#task-cloud-03) — D1 physical mapping/migration runner for notes.* tables. *Why:* the canonical notes schema needs real migrations<br>**artifact** [CLOUD.06](#task-cloud-06) — the shared atomic family engine, since synced content mutation is a named shared-transaction family. *Why:* publication/receipts/Resource/Entitlement enlistment share the commit per the WP text<br>**contract** [CON.91](contracts.md#task-con-91) — published Notes owner-body records (documents, blocks, properties) in the foundation closure. *Why:* [WP-25](../../work-packages/25-sync-engine-and-blob-lifecycle.md#rule-wp-25)'s own upstream input is explicitly 'a format proven to round-trip locally' -- Cloud's canonical schema mirrors that proven local format rather than inventing a second one<br>**contract** [CON.20](contracts.md#task-con-20) — published NotesService operations. *Why:* Cloud Notes authority implements the generated notes operations<br>**artifact** [CON.03](contracts.md#task-con-03) — real CON.03 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CON.09](contracts.md#task-con-09) — real CON.09 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.01](#task-cloud-01) — real [WP-21.00](../../work-packages/21-cloud-host-and-persistence.md#rule-wp-21.00) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
...
| Start prerequisites | **artifact** [CLOUD.45](#task-cloud-45) — real CLOUD.45 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NOTES.33](arcnotes.md#task-notes-33) — real [WP-19.05](../../work-packages/19-arcnotes-search-and-portability.md#rule-wp-19.05) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [AST.21](assistant.md#task-ast-21) — assistant history export consuming the real Cloud export producer. *Why:* runtime export fixtures are removed only after every consumer uses the real producer |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [CLOUD.47](#task-cloud-47) |
| Write scope |  |
...
| Start prerequisites | **artifact** [CLOUD.06](#task-cloud-06) — real CLOUD.06 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.16](#task-cloud-16) — real CLOUD.16 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [COM.09](commerce.md#task-com-09) — real [WP-42](../../work-packages/42-commerce-entitlement-and-credits.md#rule-wp-42) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
...
| Start prerequisites | **artifact** [CLOUD.28](#task-cloud-28) — real CLOUD.28 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [COM.13](commerce.md#task-com-13) — real [WP-42](../../work-packages/42-commerce-entitlement-and-credits.md#rule-wp-42) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [POL.05](policy.md#task-pol-05) — real [WP-44](../../work-packages/44-dynamic-policy-and-configuration.md#rule-wp-44) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [OPS.05](operations.md#task-ops-05) — real [WP-45](../../work-packages/45-operations-support-and-trust-safety.md#rule-wp-45) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | none |
| Write scope |  |
...
| Start prerequisites | **artifact** [CLOUD.15](#task-cloud-15) — real CLOUD.15 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [COM.10](commerce.md#task-com-10) — real [WP-42](../../work-packages/42-commerce-entitlement-and-credits.md#rule-wp-42) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [AND.07](android.md#task-and-07) — real [WP-23](../../work-packages/23-public-api-and-generated-clients.md#rule-wp-23) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [CLOUD.20](#task-cloud-20) |
| Write scope |  |
...
| Start prerequisites | **artifact** [CLOUD.51](#task-cloud-51) — real CLOUD.51 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [HAR.05](harness.md#task-har-05) — real [WP-52](../../work-packages/52-cloud-harness.md#rule-wp-52) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
