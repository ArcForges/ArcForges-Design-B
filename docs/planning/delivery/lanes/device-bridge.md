...
| [DEV.13](#task-dev-13) | Real Harness-planned tool request flowing through the real device bridge end-to-end | integration | M | [DEV.09](#task-dev-09) (artifact), [AST.19](assistant.md#task-ast-19) (artifact), [HAR.02](harness.md#task-har-02) (artifact) | not-started |
| [DEV.14](#task-dev-14) | Real device tool bridge over the deployed realtime transport | integration | M | [CLOUD.29](cloud.md#task-cloud-29) (artifact), [CLOUD.30](cloud.md#task-cloud-30) (artifact), [CLOUD.31](cloud.md#task-cloud-31) (artifact), [CLOUD.33](cloud.md#task-cloud-33) (artifact), [CLOUD.34](cloud.md#task-cloud-34) (artifact), [DEV.09](#task-dev-09) (artifact), [AST.11](assistant.md#task-ast-11) (artifact) | not-started |
...
| Unblocks | [DEV.02](#task-dev-02), [DEV.09](#task-dev-09) |
...
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [DEV.04](#task-dev-04), [DEV.06](#task-dev-06), [DEV.07](#task-dev-07), [DEV.08](#task-dev-08), [DEV.09](#task-dev-09) |
...
| Completion prerequisites | none |
| Unblocks | [DEV.05](#task-dev-05), [DEV.06](#task-dev-06), [DEV.09](#task-dev-09), [SLATE.33](arcslate.md#task-slate-33) |
...
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [DEV.09](#task-dev-09), [DEV.12](#task-dev-12) |
| Write scope | `Cloud:src/ArcForges.Cloud/ToolBridge/**` |
| Shared resources | [RES-cloud-d1-migrations](../shared-resources.md#res-cloud-d1-migrations) (append) |
...
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [AND.25](android.md#task-and-25), [DEV.13](#task-dev-13), [DEV.14](#task-dev-14), [WEB.28](web.md#task-web-28) |
...
| Start prerequisites | **artifact** [DEV.04](#task-dev-04) — real DEV.04 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [DEV.05](#task-dev-05) — real DEV.05 available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [CLOUD.36](cloud.md#task-cloud-36), [DEV.09](#task-dev-09) |
| Write scope |  |
...
| Start prerequisites | **artifact** [DEV.09](#task-dev-09) — real DEV.09 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [AST.19](assistant.md#task-ast-19) — real [WP-52.05](../../work-packages/52-cloud-harness.md#rule-wp-52.05) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [HAR.02](harness.md#task-har-02) — real Harness approval and tool-dispatch path. *Why:* a Harness-planned tool request must originate from the real approval and dispatch loop |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
...
| Start prerequisites | **artifact** [CLOUD.29](cloud.md#task-cloud-29) — real CLOUD.29 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.30](cloud.md#task-cloud-30) — real CLOUD.30 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.31](cloud.md#task-cloud-31) — real CLOUD.31 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.33](cloud.md#task-cloud-33) — real CLOUD.33 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.34](cloud.md#task-cloud-34) — real CLOUD.34 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [DEV.09](#task-dev-09) — real [WP-26](../../work-packages/26-remote-action-and-tool-bridge.md#rule-wp-26) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [AST.11](assistant.md#task-ast-11) — assistant Cloud client and device runtime. *Why:* the real bridge integration replaces the loopback used by the assistant device runtime |
| Entry condition | [ADOPT.02](adoption.md#task-adopt-02) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
