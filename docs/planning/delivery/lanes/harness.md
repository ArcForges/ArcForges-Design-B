...
| Start prerequisites | **artifact** [HAR.06](#task-har-06) — real HAR.06 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [AIR.09](ai-routing.md#task-air-09) — real AIR.09 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SLATE.30](arcslate.md#task-slate-30) — real [WP-39](../../work-packages/39-arcslate-integration-and-portability.md#rule-wp-39) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [AIR.08](ai-routing.md#task-air-08) — real [WP-43.07](../../work-packages/43-managed-ai-routing-and-metering.md#rule-wp-43.07) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.08](adoption.md#task-adopt-08) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
