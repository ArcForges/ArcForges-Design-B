...
| Notes | No hard start-dependency on any other WP -- can begin immediately using a real TCP/UDP loopback or serial-over-USB pair; exotic hardware is not required for the first real-transport configuration (see report SS4 on [PG-08](../../../assurance/open-gates-register.md#rule-pg-08) phasing). Parallel with NAT.01/02/04. |
...
| Notes | Degradation-path code (enumeration, driver-absence reporting) does not require the [PG-08](../../../assurance/open-gates-register.md#rule-pg-08) lab to exist; the physical hot-unplug/permission-denial matrix against a named USB device does. See report SS4 for the full [PG-08](../../../assurance/open-gates-register.md#rule-pg-08) phasing answer. |
...
| Start prerequisites | **artifact** [PRF.01](runtime-proofs.md#task-prf-01) — real PRF.01 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.02](runtime-proofs.md#task-prf-02) — real PRF.02 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.03](runtime-proofs.md#task-prf-03) — real PRF.03 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.04](runtime-proofs.md#task-prf-04) — real PRF.04 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.05](runtime-proofs.md#task-prf-05) — real PRF.05 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.06](runtime-proofs.md#task-prf-06) — real PRF.06 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.07](runtime-proofs.md#task-prf-07) — real PRF.07 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.08](runtime-proofs.md#task-prf-08) — real PRF.08 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.09](runtime-proofs.md#task-prf-09) — real PRF.09 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.10](runtime-proofs.md#task-prf-10) — real PRF.10 available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.02](adoption.md#task-adopt-02) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | none |
| Write scope |  |
...
| Start prerequisites | **artifact** [NAT.06](#task-nat-06) — real NAT.06 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.07](#task-nat-07) — real NAT.07 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.08](#task-nat-08) — real NAT.08 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.09](#task-nat-09) — real NAT.09 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.10](#task-nat-10) — real NAT.10 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.11](#task-nat-11) — real NAT.11 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.12](#task-nat-12) — real NAT.12 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.13](#task-nat-13) — real NAT.13 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.14](#task-nat-14) — real NAT.14 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.15](#task-nat-15) — real NAT.15 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.20](#task-nat-20) — real NAT.20 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.21](#task-nat-21) — real NAT.21 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.22](#task-nat-22) — real NAT.22 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.23](#task-nat-23) — real NAT.23 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.24](#task-nat-24) — real NAT.24 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.25](#task-nat-25) — real NAT.25 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.26](#task-nat-26) — real NAT.26 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.28](#task-nat-28) — real NAT.28 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NAT.01](#task-nat-01) — package task delivered. *Why:* the package acceptance receipt verifies every task mapped to the package ([DLV-03](../README.md#rule-dlv-03))<br>**artifact** [NAT.02](#task-nat-02) — package task delivered. *Why:* the package acceptance receipt verifies every task mapped to the package ([DLV-03](../README.md#rule-dlv-03))<br>**artifact** [NAT.03](#task-nat-03) — package task delivered. *Why:* the package acceptance receipt verifies every task mapped to the package ([DLV-03](../README.md#rule-dlv-03))<br>**artifact** [NAT.04](#task-nat-04) — package task delivered. *Why:* the package acceptance receipt verifies every task mapped to the package ([DLV-03](../README.md#rule-dlv-03))<br>**artifact** [NAT.05](#task-nat-05) — package task delivered. *Why:* the package acceptance receipt verifies every task mapped to the package ([DLV-03](../README.md#rule-dlv-03))<br>**artifact** [PLT.54](platform.md#task-plt-54) — package task delivered. *Why:* the package acceptance receipt verifies every task mapped to the package ([DLV-03](../README.md#rule-dlv-03)) |
| Entry condition | [ADOPT.02](adoption.md#task-adopt-02) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | none |
| Write scope |  |
