...
| Validation | Offline/local tests against actual OS streams on the build machine (Named Pipe on Windows, UDS on Linux - not hosted-runtime CI, but ordinary process-local sockets the repo's own CI already exercises for native ABI tests): malformed frames, wrong-user denial, assertion of no local TCP listener. |
...
| Baseline (unreviewed unless accepted) | not-started Observed scaffold, unreviewed: ArcForges.Security.Secrets does not exist as a separate project yet; the WP11 architecture doc names it as a new project distinct from the single 'ArcForges.Security' package registry row - see report section 9 for this naming inconsistency. |
...
| Start prerequisites | **artifact** [PLT.35](#task-plt-35) — real PLT.35 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [NOTES.03](arcnotes.md#task-notes-03) — real [WP-18.00](../../work-packages/18-arcnotes-document-core.md#rule-wp-18.00) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SCOPE.09](arcscope.md#task-scope-09) — real [WP-33.00](../../work-packages/33-arcscope-acquisition-and-session.md#rule-wp-33.00) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SLATE.22](arcslate.md#task-slate-22) — real [WP-36.00](../../work-packages/36-arcslate-project-and-timeline.md#rule-wp-36.00) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.02](adoption.md#task-adopt-02) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [PLT.35](#task-plt-35) |
| Write scope |  |
...
| Start prerequisites | **artifact** [PLT.24](#task-plt-24) — real PLT.24 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PLT.38](#task-plt-38) — real PLT.38 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [APP.01](app-composition.md#task-app-01) — real [WP-14.00](../../work-packages/14-hub-and-minimal-provider-slice.md#rule-wp-14.00) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.02](adoption.md#task-adopt-02) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
