...
| Start prerequisites | **artifact** [SIM.05](#task-sim-05) — real SIM.05 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SIM.06](#task-sim-06) — real SIM.06 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SCOPE.14](arcscope.md#task-scope-14) — real SCOPE.14 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SCOPE.18](arcscope.md#task-scope-18) — real SCOPE.18 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SCOPE.24](arcscope.md#task-scope-24) — real SCOPE.24 available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
...
| Start prerequisites | **artifact** [CLOUD.07](cloud.md#task-cloud-07) — real CLOUD.07 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [SIM.01](#task-sim-01) — real [WP-51](../../work-packages/51-arcscope-cloud-simulator.md#rule-wp-51) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.07](adoption.md#task-adopt-07) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
