...
| [WEB.28](#task-web-28) | Real desktop tool dispatch from the browser companion | integration | M | [WEB.21](#task-web-21) (artifact), [WEB.23](#task-web-23) (artifact), [DEV.09](device-bridge.md#task-dev-09) (artifact) | not-started |
...
| [WEB.31](#task-web-31) | Full browser-support.v1 matrix across all Web-facing outputs | integration | M | [CLOUD.28](cloud.md#task-cloud-28) (artifact), [OPS.05](operations.md#task-ops-05) (artifact), [WEB.07](#task-web-07) (artifact), [WEB.14](#task-web-14) (artifact), [WEB.19](#task-web-19) (artifact) | not-started |
...
| Start prerequisites | **artifact** [WEB.20](#task-web-20) — real WEB.20 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [WEB.21](#task-web-21) — real WEB.21 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [HAR.00](harness.md#task-har-00) — real [WP-52](../../work-packages/52-cloud-harness.md#rule-wp-52) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [HAR.03](harness.md#task-har-03) — real generated streaming and durable output. *Why:* the browser end-to-end scenario reads real Harness output |
| Entry condition | [ADOPT.09](adoption.md#task-adopt-09) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
...
| Start prerequisites | **artifact** [WEB.21](#task-web-21) — real WEB.21 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [WEB.23](#task-web-23) — real WEB.23 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [DEV.09](device-bridge.md#task-dev-09) — real [WP-26](../../work-packages/26-remote-action-and-tool-bridge.md#rule-wp-26) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.09](adoption.md#task-adopt-09) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
...
| Start prerequisites | **artifact** [WEB.14](#task-web-14) — real WEB.14 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [COM.14](commerce.md#task-com-14) — real [WP-42](../../work-packages/42-commerce-entitlement-and-credits.md#rule-wp-42) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [POL.08](policy.md#task-pol-08) — real [WP-44](../../work-packages/44-dynamic-policy-and-configuration.md#rule-wp-44) available. *Why:* integration scenario needs the real producer and consumer |
| Entry condition | [ADOPT.09](adoption.md#task-adopt-09) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [WEB.18](#task-web-18) |
| Write scope |  |
...
| Start prerequisites | **artifact** [CLOUD.19](cloud.md#task-cloud-19) — real CLOUD.19 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.26](cloud.md#task-cloud-26) — real CLOUD.26 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [CLOUD.29](cloud.md#task-cloud-29) — real CLOUD.29 available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [WEB.07](#task-web-07) — real [WP-47](../../work-packages/47-static-public-site.md#rule-wp-47) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [WEB.14](#task-web-14) — real [WP-48](../../work-packages/48-account-portal.md#rule-wp-48) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [WEB.19](#task-web-19) — real [WP-49](../../work-packages/49-arcchat-web-companion.md#rule-wp-49) available. *Why:* integration scenario needs the real producer and consumer<br>**artifact** [PRF.08](runtime-proofs.md#task-prf-08) — React production build and generated SDK proof using MSW fixtures. *Why:* the real-client integration replaces the fixture-backed proof path |
| Entry condition | [ADOPT.09](adoption.md#task-adopt-09) — adoption of the owning repository is complete ([DLV-22](../README.md#rule-dlv-22)) |
| Completion prerequisites | none |
| Unblocks | [CLOUD.28](cloud.md#task-cloud-28) |
| Write scope |  |
| Validation | Local real-integration run of the affected scenario in an existing environment, recorded once; offline and static checks in CI; no hosted runtime, device, browser, live-service or inference CI ([P2-017](../../../decisions/phase-2-specification-decisions.md#rule-p2-017)). |
